...
<script type="text/javascript">
	...
	$.validator.addMethod(
		...
		function(value,element,params){
			...
			//value:输入验证码的内容进行ajax校验
			//element:被校验的元素对象
			//params:规则对应的参数值
			if("${sessionScope.checkcode_session }"==value){
				flag = true;
			}else{
				flag = false;
			}
...
<script type="text/javascript">
    	window.onload = function(){
    		//alert("${sessionScope.checkcode_session}");
    	}
				...
				<form class="form-horizontal" id="myform" action="${pageContext.request.contextPath }/user?method=register" method="post" style="margin-top: 5px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							...
							<div class="validateInfo"><%=request.getAttribute("validateInfo")==null?"":request.getAttribute("validateInfo")%></div>
						</div>
						
						
						<div class="col-sm-2">
							<img class="img" onclick="changeImg(this)" src="${pageContext.request.contextPath }/checkImg" />
						</div>
