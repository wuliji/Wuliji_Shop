				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProductList }" var="hotPro">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${hotPro.pid}&cid=${hotPro.cid}&currentPage=${currentPage}">
								<img src="${pageContext.request.contextPath }/${hotPro.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${hotPro.pid}&cid=${hotPro.cid}&currentPage=${currentPage}" style='color:#666'>${hotPro.pname }</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProductList }" var="newPro">
							<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
								<a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${newPro.pid}&cid=${newPro.cid}&currentPage=${currentPage}">
									<img src="${pageContext.request.contextPath }/${newPro.pimage }" width="130" height="130" style="display: inline-block;">
								</a>
								<p><a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${newPro.pid}&cid=${newPro.cid}&currentPage=${currentPage}" style='color:#666'>${newPro.pname }</a></p>
