	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath }/product?method=index">首页&nbsp;&nbsp;&gt;</a> <a href="${pageContext.request.contextPath }/product?method=productList&cid=${cid}&currentPage=${currentPage}">${cname }&nbsp;&nbsp;&gt;</a>
				<a>${product.pname }</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div>
						<a href="${pageContext.request.contextPath}/product?method=productList&cid=${cid}&currentPage=${currentPage}">返回列表</a>
					</div>
