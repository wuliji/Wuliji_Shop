							...
							<tbody>
								...
								<c:forEach items="${cart.cartItems }" var="entry">
									<tr class="active">
										...
										<td width="30%">
											<a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${entry.value.product.pid}&
											cid=${entry.value.product.cid}&currentPage=${currentPage}">${entry.value.product.pname}</a>
										</td>
										<td width="20%">
